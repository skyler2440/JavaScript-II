...
let fullName=[];
let names = runners.forEach(function (name) {
...
let ticketPriceTotal = runners.reduce((total, donor) => {
    return total += donor.donation;
}, 0);
...
// Problem 1
let largeDonors = runners.filter((donor)=>{
    return donor.donation > 200;
});
console.log(largeDonors);
// Problem 2
let goalTotal = runners.reduce((total, donor) => {
    return total += donor.donation;
}, -10000);
console.log(`We are ${goalTotal} short of our goal of 10k`);
// Problem 3
let
